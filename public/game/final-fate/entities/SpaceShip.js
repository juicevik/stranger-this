...
class SpaceShip extends GameObject {
    ...
    constructor(middleX, middleY) {
        ...
        super.renderState = function () {
            ...
            context.fillRect((this.middleX - 1) * 10, (this.middleY - 4) * 10, 30, 10);
            context.fillStyle = "#ffd2a6";
            context.fillRect(this.middleX * 10, (this.middleY - 3) * 10, 10, 10);
            context.fillStyle = "#253a58";
            context.fillRect((this.middleX - 1) * 10, (this.middleY - 2) * 10, 30, 20);
            ...
            context.fillRect((this.middleX - 1) * 10, (this.middleY - 5) * 10, 30, 4);
