...
loaders[4] = metallicMoonLoader;
//Level names.
var level_names = new Array(7);
level_names[0] = "Small Town";
level_names[1] = "Power Lab";
level_names[2] = "Signal Forest";
level_names[3] = "Mirror Realm";
level_names[4] = "Red Moon";
